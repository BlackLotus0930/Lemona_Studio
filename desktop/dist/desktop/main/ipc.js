        ...
        try {
            ...
            (async () => {
                try {
                    ...
                    const stream = await modelGatewayService.streamChat(googleApiKey, openaiApiKey, message, documentContent, finalProjectId, chatHistory, useWebSearch, modelName, attachments, style, (progressEvent) => {
