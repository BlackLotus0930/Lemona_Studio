// Desktop Chat History Service - Stores chat history in projects (shared across all documents in a project)
...
export const chatHistoryService = {
   ...
   */
  async getProjectIdFromDocument(documentId: string): Promise<string | null> {
