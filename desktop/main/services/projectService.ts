// Desktop Project Service - Manages projects and their documents
import { Project, Document } from '../../../shared/types.js'
...
export const projectService = {
   ...
   */
  async create(title: string, description?: string, intent?: string): Promise<Project> {
    await ensureProjectsDir()
   ...
   */
  async updateIntent(id: string, intent: string): Promise<Project | null> {
   ...
   */
  async addDocument(projectId: string, documentId: string, order?: number): Promise<Project | null> {
   ...
   */
  async reorderDocuments(projectId: string, documentIds: string[]): Promise<Project | null> {
    const project = await this.getById(projectId)
    if (!project) {
      return null
    }
